...
#     system_ID == "Aedes aegypti+ZIKV" ~ "(b) *Ae. aegypti* and ZIKV",
#     system_ID == "Aedes albopictus+DENV" ~ "(c\u200b) *Ae. albopictus* and DENV",
#     system_ID == "Anopheles spp.+P.fal." ~ "(d) *An. gambiae* and *P. falciparum*",
#     system_ID == "Culex quinquefasciatus+WNV" ~ "(e) *Cx. quinquefasciatus* and WNV"
#   ))
...
Toptalt_plots <- Toptalt_df %>%
  ...
  geom_contour(data = filter(data.CT, variable == "CTwidth", sigmaH < infinite_divide),
...
CTWidth_heat_plots <- CTwidth_df %>%
  ...
  geom_contour_filled(data = filter(CTwidth_df, 
                                    sigmaH_proxy > 10^2.4, 
...
plot.ddTR0.rel.sens <- ddTR0.HPD %>% 
  ...
  scale_y_continuous(
    name = unname(TeX("Relative contribution to $\\frac{d}{dT}R_0$ HPD width"))
  ) +
  facet_grid(cols = vars(system_label),
             rows = vars(KH, sigmaH), 
             labeller = labeller(
