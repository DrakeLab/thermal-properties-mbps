...
```{r fig-S8_2_dR0dvar_uncertainty, dev = c('pdf','svg', 'png'), message=FALSE, out.width='100%', fig.width=9, fig.height=6, fig.align='center', fig.cap='\\label{fig:R0_unc} The uncertainty in the local sensitivity of $\\mathcal{R}_0$ with respect to mosquito life history traits.'}
